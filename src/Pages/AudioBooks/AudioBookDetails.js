...
const AudioBookDetails = () => {
  const { id } = useParams();
  const url = `https://books-store-server.vercel.app/api/v1/books/audioBook/${id}`;
      ...
      <div className="container-width my-16 mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 mx-auto">
          ...
          <div className="Details-content flex-2/4 px-5 md:px-10 lg:px-0">
            ...
            <p className="">
              By <span className="hover:underline text-sm">{author}</span>
            </p>
            ...
            <div className="price-range">
              <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 lg:gap-2 ">
                {priceRange.map((priceBox) => {
                  ...
                  return (
                    <div className=" p-2 border hover:border-1 hover:border-gray-700  hover:bg-slate-100 text-center leading-5 text-sm lg:mt-4 mb-0 xl:mb-2">
                      <h1>{name}</h1>
