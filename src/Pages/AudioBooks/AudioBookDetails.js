...
const AudioBookDetails = () => {
    ...
    const { isLoading, data: Book } = useQuery("AudioBooks", () =>
      fetch(url)
      .then((res) => 
      res.json())
    );
    ...
    const {img, title, price, discount, author, rating} = Book;
     ...
     <div className="container-width my-16 mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 mx-auto">
            ...
            <div className="Details-content flex-2/4 px-5 md:px-10 lg:px-0">
                ...
                <p className=''>By <span className='hover:underline text-sm'>{author}</span></p>
                ...
                <div className="price flex items-center space-x-2 my-2 lg:my-0">
                 ...
                 <h1 className='text-pink-600 font-semibold'>Save {discount}%</h1>
                 </div>
                </div>
               ...
               <div className="btn-groups flex md:flex-row flex-col md:space-x-3 my-4 space-y-3 md:space-y-0">
                <button className='py-2 px-8 bg-blue-700 uppercase font-medium text-white hover:bg-opacity-80'>Buy Now</button>
                <button className='py-2 px-8 border border-1 border-black hover:text-white hover:bg-black font-medium'>Sign In To Punches Instantly</button>
               </div>
