    ...
    <div className="mb-20">
      ...
      <section>
        ...
        <p className="text-center max-w-3xl mx-auto my-10 font-medium">
          Audiobooks are voice recordings of a book being read out loud so that
          you can listen to the story rather than read the text. Audiobooks are
          popular because of the ability to multitask. Audiobooks can be
      ...
      <section>
        <div className="border max-w-4xl mx-auto px-5 py-10 mt-20">
          <p className="text-sm">
            If you’re looking for where to buy audiobooks, you’ve come to the
            right place. Listen to audiobooks on the free Barnes & Noble NOOK
            app for easy listening wherever you go. Shop thousands of
            bestsellers, new releases, and classics, all in one place. Browse
            audiobooks read by talented narrators and celebrities including
          ...
          <h2 className="text-2xl font-semibold mt-5">What is an audiobook?</h2>
          <p className="text-sm">
            Audiobooks are voice recordings of a book being read out loud so
